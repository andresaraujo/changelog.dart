...
writeChangelog(io.File file, List<LogEntry> entries, ChangelogConfig config) {
  ...
  if(oldContent.length > 0)
    file.writeAsStringSync(UTF8.decode(oldContent), mode: io.FileMode.APPEND);
}

String buildContentToWrite(StringBuffer content, List<LogEntry> entries, ChangelogConfig config) {
  Map sections = {};
